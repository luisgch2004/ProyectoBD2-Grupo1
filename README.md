# 🏥 FISICLINICA - Sistema de Gestión de Atención Médica

![Java](https://img.shields.io/badge/Java-17%2B-orange) ![Oracle](https://img.shields.io/badge/Database-Oracle-red) ![Gradle](https://img.shields.io/badge/Build-Gradle-green) ![Swing](https://img.shields.io/badge/GUI-Swing-blue)

**Fisiclinica** es una solución empresarial de escritorio desarrollada en **Java (Swing)** para la gestión integral de centros de salud comunitarios. El sistema implementa una arquitectura robusta utilizando una base de datos **Oracle** con lógica de negocio encapsulada en **PL/SQL** y un estricto control de acceso basado en roles (RBAC).

---

## 🚀 Características Principales

* **Gestión de Pacientes:** Admisión, historia clínica, eliminación lógica ("Papelera") y reactivación de pacientes.
* **Consultas Médicas:** Diagnóstico, tratamiento, seguimiento de estado y cancelación.
* **Farmacia e Inventario:** Control de stock, alertas automáticas de "Stock Bajo", gestión de lotes y recuperación de medicamentos descontinuados.
* **Donaciones:** Módulo financiero para el registro de ingresos y donaciones con selectores de fecha y moneda.
* **Seguridad Avanzada:** Autenticación con Hashing SHA-256 y roles de base de datos nativos.

---

## 🛠️ Tecnologías

* **Backend DB:** Oracle Database (XE/19c/21c) + PL/SQL.
* **Backend App:** Java 17 + JDBC (OJDBC11).
* **Frontend:** Java Swing con diseño personalizado (`Estilos.java`).
* **Gestión de Proyectos:** Gradle.
* **Librerías:** `JCalendar` (para selección de fechas).

---

## 👥 Roles de Usuario y Accesos

El sistema implementa 5 roles jerárquicos definidos en la base de datos:

| Rol | Descripción | Acceso en el Sistema |
| :--- | :--- | :--- |
| **ADMINISTRADOR** | Control total | Todo el sistema |
| **MÉDICO** | Personal clínico | Pacientes, Consultas, Medicamentos |
| **CAJA** | Admisión y pagos | Pacientes, Consultas |
| **FARMACIA** | Despacho | Medicamentos |
| **FINANZAS** | Contabilidad | Donaciones |

---

## ⚙️ Guía de Inicialización (Base de Datos)

Para desplegar la aplicación, debes ejecutar los siguientes scripts SQL en tu herramienta de base de datos (SQL Developer, Navicat, etc.) en el orden estricto que se presenta.

### PASO 1: Infraestructura
**👤 Ejecutar como:** `SYSTEM` (o SYS as SYSDBA)
...
### PASO 2: Lógica y Datos
**👤 Ejecutar como:** `fisiclinica_admin` (Contraseña: `Admin2024$Fisiclinica`)
...
COMMIT;
```
## 🔐 Configuración de Conexión Java
Asegúrate de que tu archivo `DatabaseConnection.java` coincida con esta configuración:
```sql
private static final String DB_URL = "jdbc:oracle:thin:@localhost:1521:XE"; // O tu ServiceName
...
* `admin@fisiclinica.pe` (ADMINISTRADOR)
* `medico@fisiclinica.pe` (MÉDICO)
* `caja@fisiclinica.pe` (CAJA)
* `farmacia@fisiclinica.pe` (FARMACIA)
* `finanzas@fisiclinica.pe` (FINANZAS)
